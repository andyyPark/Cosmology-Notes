...
\input{GalacticDynamics/gravitation}
...
\input{Covariance/introduction}
\input{Covariance/decomposition}
...
\input{Halo/introduction}
\input{Halo/halomodel}
\input{Halo/discrete}
\input{Halo/ingredients}

\section{Miscellanesou}
\input{Miscellaneous/tophat}
